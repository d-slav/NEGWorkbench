...
Jsou-li L1 a L2 rovnobezne, je to legitimni "nema reseni" pripad
(NoSolution - viz errors.py), ne bug.
...
stred CM (P20/line_intersection). P20 sama hlasi rovnobezne primky
jako obycejny ValueError (sdili se s uz drive hotovymi opcody, napr.
C02 - ty se zatim nemeni, viz konverzace) - tady se to prevede na
NoSolution jen lokalne, pro C32 samotne.
"""
...
def tangent_to_two_lines(line1, line2, radius, kk):
    ...
    try:
        ...
        raise NoSolution("C32: primky L1 a L2 jsou rovnobezne - %s" % exc)
